...
from day04.solution1 import get_number_of_winning_numbers_matched, parse_row
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('Card 12: 87 | 88', ([87], [88])),
        # two spaces
        ('Card 12: 87 86 | 9  88', ([87, 86], [9, 88])),
    ]
)
def test_parse_row(test_input, expected):
    actual_winning_numbers, actual_numbers = parse_row(test_input)
    expected_winning_numbers, expected_numbers = expected
